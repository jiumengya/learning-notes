...
![img](./assets/b98175d8a9798669485b7532186d9f82.png)

![img](./assets/e7b2048c652a090aaa9a77a43044863a.png)
...
- 在方法体内部声明的变量称为**局部变量**。
  ...
  ![img](./assets/58fa3b6eb659d69e11d281fb6a2364ea.png)
...
- 在方法体内部声明的变量称为**局部变量**。
  ...
  ![img](./assets/58fa3b6eb659d69e11d281fb6a2364ea-1668753589092-7.png)
...
![img](./assets/02a30584b81301520637d3b982d0bede.png)
...
### 3.3.4、[布尔](https://so.csdn.net/so/search?q=布尔&spm=1001.2101.3001.7020)类型：boolean
...
## 3.3、基本数据[类型转换](https://so.csdn.net/so/search?q=类型转换&spm=1001.2101.3001.7020)

- 自动类型转换：容量小的类型自动转换为容量大的数据类型。数据类型按容量大小排序为：

  ![img](./assets/5f55de57c32a87d59ef581f39d0a92e6.png)
...
## 3.3、[字符串](https://so.csdn.net/so/search?q=字符串&spm=1001.2101.3001.7020)类型：String
...
## 3.4、[强制类型转换](https://so.csdn.net/so/search?q=强制类型转换&spm=1001.2101.3001.7020)
...
# 04、[进制](https://so.csdn.net/so/search?q=进制&spm=1001.2101.3001.7020)
...
![img](./assets/7775c47e49965529b779183a44e41fb9.png)

**二进制——》十进制**

![img](./assets/c2d9860f3b822dbeabac4b4ff6e0c7c5.png)

> 原码与反码是帮助推导出补码而存在的！！！

十进制——》二进制

![img](./assets/a200a439100aaa2c2721deb5c8664693.png)
...
![img](./assets/050e3f2cd04de75da6e70a074670260d.png)

![img](./assets/b3386e2cd8b7990a222895f6b0472d33.png)