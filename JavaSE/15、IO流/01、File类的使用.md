 ...
 *         要想保证返回true,需要file1在硬盘中是存在的，且file2不能在硬盘中存在,但文件夹必须存在。
 */
    @Test
    public void testFile01(){
        File file1 = new File("e://nums.txt");//存在
        File file2 = new File("e://软件/test.txt");//不存在
...
![img](./assets/image-1668760173867-1.png)
